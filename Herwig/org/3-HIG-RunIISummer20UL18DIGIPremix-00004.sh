...
# Dump actual test code to a HIG-RunIISummer20UL18DIGIPremix-00004_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL18DIGIPremix-00004_test.sh
#!/bin/bash
...
# Target input events changed to: `minimum_runtime / time_per_event * number_of_threads`: `600 / 1.73 * 1` = 347
# Target output events changed to: `target_input_events * event_efficiency`: `347 * 1` = 347
# Final target input events: 346
# Final target output events: 346
# This validation will be computed based on the target output events!
EVENTS=346


# cmsDriver command
cmsDriver.py  --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI --conditions 106X_upgrade2018_realistic_v11_L1v1 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --datamix PreMix --era Run2_2018 --python_filename HIG-RunIISummer20UL18DIGIPremix-00004_1_cfg.py --fileout file:HIG-RunIISummer20UL18DIGIPremix-00004.root --filein file:HIG-RunIISummer20UL18SIM-00004.root --number 346 --number_out 346 --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer20ULPrePremix-UL18_106X_upgrade2018_realistic_v11_L1v1-v2/PREMIX" --runUnscheduled --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL18DIGIPremix-00004_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18DIGIPremix-00004_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18DIGIPremix-00004_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18DIGIPremix-00004 sequence 1/1"
...
# End of HIG-RunIISummer20UL18DIGIPremix-00004_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL18DIGIPremix-00004_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL18DIGIPremix-00004_test.sh)
