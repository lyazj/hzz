...
# Dump actual test code to a HIG-RunIISummer20UL17MiniAODv2-00675_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL17MiniAODv2-00675_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 106X_mc2017_realistic_v9 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --era Run2_2017 --python_filename HIG-RunIISummer20UL17MiniAODv2-00675_1_cfg.py --fileout file:HIG-RunIISummer20UL17MiniAODv2-00675.root --filein "dbs:/GluGluHToZZTo4L_M125_TuneCP5_13TeV_powheg2_JHUGenV7011_pythia8/RunIISummer20UL17RECO-106X_mc2017_realistic_v6-v2/AODSIM" --number 1769 --number_out 1769 --runUnscheduled --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL17MiniAODv2-00675_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL17MiniAODv2-00675_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL17MiniAODv2-00675_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL17MiniAODv2-00675 sequence 1/1"
...
# End of HIG-RunIISummer20UL17MiniAODv2-00675_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL17MiniAODv2-00675_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL17MiniAODv2-00675_test.sh)
