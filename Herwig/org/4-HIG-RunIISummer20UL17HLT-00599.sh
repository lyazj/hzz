...
# Dump actual test code to a HIG-RunIISummer20UL17HLT-00599_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL17HLT-00599_test.sh
#!/bin/bash
...
echo "Validation report of HIG-RunIISummer20UL17HLT-00599 sequence 1/1"
...
# End of HIG-RunIISummer20UL17HLT-00599_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL17HLT-00599_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL17HLT-00599_test.sh)
