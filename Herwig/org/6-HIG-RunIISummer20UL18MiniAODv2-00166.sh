...
# Dump actual test code to a HIG-RunIISummer20UL18MiniAODv2-00166_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL18MiniAODv2-00166_test.sh
#!/bin/bash
...
# Target input events changed to: `minimum_runtime / time_per_event * number_of_threads`: `600 / 0.6 * 1` = 1e+03
# Target output events changed to: `target_input_events * event_efficiency`: `1e+03 * 1` = 1e+03
# Final target input events: 1000
# Final target output events: 1000
# This validation will be computed based on the target output events!
EVENTS=1000


# cmsDriver command
cmsDriver.py  --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --era Run2_2018 --python_filename HIG-RunIISummer20UL18MiniAODv2-00166_1_cfg.py --fileout file:HIG-RunIISummer20UL18MiniAODv2-00166.root --filein "dbs:/GluGluHToZZTo4L_M125_TuneCP5_13TeV_powheg2_JHUGenV7011_pythia8/RunIISummer20UL18RECO-106X_upgrade2018_realistic_v11_L1v1-v1/AODSIM" --number 1000 --number_out 1000 --runUnscheduled --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL18MiniAODv2-00166_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18MiniAODv2-00166_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18MiniAODv2-00166_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18MiniAODv2-00166 sequence 1/1"
...
# End of HIG-RunIISummer20UL18MiniAODv2-00166_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL18MiniAODv2-00166_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL18MiniAODv2-00166_test.sh)
