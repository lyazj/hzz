...
# Dump actual test code to a HIG-RunIISummer20UL18NanoAODv9-00162_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL18NanoAODv9-00162_test.sh
#!/bin/bash
...
# Target input events changed to: `minimum_runtime / time_per_event * number_of_threads`: `600 / 0.43 * 1` = 1.4e+03
# Target output events changed to: `target_input_events * event_efficiency`: `1.4e+03 * 1` = 1.4e+03
# Final target input events: 1395
# Final target output events: 1395
# This validation will be computed based on the target output events!
EVENTS=1395


# cmsDriver command
cmsDriver.py  --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 106X_upgrade2018_realistic_v16_L1v1 --step NANO --era Run2_2018,run2_nanoAOD_106Xv2 --python_filename HIG-RunIISummer20UL18NanoAODv9-00162_1_cfg.py --fileout file:HIG-RunIISummer20UL18NanoAODv9-00162.root --filein "dbs:/GluGluHToZZTo4L_M125_TuneCP5_13TeV_powheg2_JHUGenV7011_pythia8/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM" --number 1395 --number_out 1395 --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL18NanoAODv9-00162_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL18NanoAODv9-00162_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL18NanoAODv9-00162_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL18NanoAODv9-00162 sequence 1/1"
...
# End of HIG-RunIISummer20UL18NanoAODv9-00162_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL18NanoAODv9-00162_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL18NanoAODv9-00162_test.sh)
