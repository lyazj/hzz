...
# Dump actual test code to a HIG-RunIISummer20UL16HLTAPV-02820_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL16HLTAPV-02820_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent RAWSIM --outputCommand "keep *_mix_*_*,keep *_genPUProtons_*_*" --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands "keep *","drop *_*_BMTF_*","drop *PixelFEDChannel*_*_*_*" --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --step HLT:25ns15e33_v4 --geometry DB:Extended --era Run2_2016 --python_filename HIG-RunIISummer20UL16HLTAPV-02820_1_cfg.py --fileout file:HIG-RunIISummer20UL16HLTAPV-02820.root --filein file:HIG-RunIISummer20UL16DIGIPremixAPV-02799.root --number 253 --number_out 253 --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL16HLTAPV-02820_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL16HLTAPV-02820_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL16HLTAPV-02820_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL16HLTAPV-02820 sequence 1/1"
...
# End of HIG-RunIISummer20UL16HLTAPV-02820_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL16HLTAPV-02820_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL16HLTAPV-02820_test.sh)
