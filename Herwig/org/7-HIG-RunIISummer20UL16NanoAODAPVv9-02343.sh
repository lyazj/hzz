...
# Dump actual test code to a HIG-RunIISummer20UL16NanoAODAPVv9-02343_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > HIG-RunIISummer20UL16NanoAODAPVv9-02343_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --python_filename HIG-RunIISummer20UL16NanoAODAPVv9-02343_1_cfg.py --fileout file:HIG-RunIISummer20UL16NanoAODAPVv9-02343.root --filein "dbs:/GluGluHToZZTo4L_M125_TuneCP5_13TeV_powheg2_JHUGenV7011_pythia8/RunIISummer20UL16MiniAODAPVv2-106X_mcRun2_asymptotic_preVFP_v11-v2/MINIAODSIM" --number 1435 --number_out 1435 --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=HIG-RunIISummer20UL16NanoAODAPVv9-02343_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME HIG-RunIISummer20UL16NanoAODAPVv9-02343_1_cfg.py || exit $? ;

# Parse values from HIG-RunIISummer20UL16NanoAODAPVv9-02343_report.xml report
...
echo "Validation report of HIG-RunIISummer20UL16NanoAODAPVv9-02343 sequence 1/1"
...
# End of HIG-RunIISummer20UL16NanoAODAPVv9-02343_test.sh file
EndOfTestFile

# Make file executable
chmod +x HIG-RunIISummer20UL16NanoAODAPVv9-02343_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/HIG-RunIISummer20UL16NanoAODAPVv9-02343_test.sh)
