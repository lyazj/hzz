...
cmsDriver.py Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGENAPV-H2684-fragment.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands 'process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int('$[$2+1]')\nprocess.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100)' --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --python_filename HIG-RunIISummer20UL16wmLHEGENAPV-H2684_1_cfg.py --fileout file:HIG-RunIISummer20UL16wmLHEGENAPV-H2684.root --mc -n $EVENTS || exit $?

enter CMSSW_10_6_17_patch1
cmsDriver.py  --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --era Run2_2016_HIPM --python_filename HIG-RunIISummer20UL16SIMAPV-02820_1_cfg.py --fileout file:HIG-RunIISummer20UL16SIMAPV-02820.root --filein file:HIG-RunIISummer20UL16wmLHEGENAPV-H2684.root --runUnscheduled --mc -n $EVENTS || exit $?
...
enter CMSSW_13_2_2
cmsDriver.py  --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --python_filename HIG-RunIISummer20UL16NanoAODAPVv12-02343_1_cfg.py --fileout file:HIG-RunIISummer20UL16NanoAODAPVv12-02343.root --filein file:HIG-RunIISummer20UL16MiniAODAPVv2-02465.root --mc -n $EVENTS || exit $?

[ ! -z "${UPLOAD}" ] && xrdcp -f HIG-RunIISummer20UL16NanoAODAPVv12-02343.root "root://eosuser.cern.ch/${UPLOAD}"
